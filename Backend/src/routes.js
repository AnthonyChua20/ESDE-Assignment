...
const validationFn = require('./middlewares/validateFn');
const verifyFn = require('./middlewares/verifyuser');
...
exports.appRoute = router => {
    ...
    // router.put('/api/user/design/',verifyFn.verifyTokenUserID ,validationFn.validateUpdateSubmission,userController.processUpdateOneDesign);
    router.put('/api/user/design/', verifyFn.verifyTokenUserID, validationFn.validateUpdateSubmission,userController.processUpdateOneDesign);
